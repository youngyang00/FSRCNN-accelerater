...
HD_PWD='C:/emergency/FSRCNN_imple2.vol1/ip_repo/AXI4S_Feature_Extraction_Layer/AXI4S_Feature_Extraction_Layer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Feature_Extraction_Layer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Feature_Extraction_Layer.tcl
