...
HD_PWD='D:/FSRCNN_imple2/ip_repo/AXIS_Y_Converter_v19.1_0910/AXIS_Y_Converter_v19.1_0910.runs/yconv_fifo_generator_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log yconv_fifo_generator_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source yconv_fifo_generator_0.tcl
