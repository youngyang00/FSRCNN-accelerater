...
HD_PWD='D:/Github_Portfolio/AXIS_IPs_v19.1_for_Integration/AXIS_Y_Converter_v19.1_0910/AXIS_Y_Converter_v19.1_0910.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Y_Converter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Y_Converter.tcl
