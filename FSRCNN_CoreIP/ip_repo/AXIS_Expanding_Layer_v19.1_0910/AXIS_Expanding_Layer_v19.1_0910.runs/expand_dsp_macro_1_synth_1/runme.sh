...
HD_PWD='D:/FSRCNN_imple2/ip_repo/AXIS_Expanding_Layer_v19.1_0910/AXIS_Expanding_Layer_v19.1_0910.runs/expand_dsp_macro_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log expand_dsp_macro_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source expand_dsp_macro_1.tcl
