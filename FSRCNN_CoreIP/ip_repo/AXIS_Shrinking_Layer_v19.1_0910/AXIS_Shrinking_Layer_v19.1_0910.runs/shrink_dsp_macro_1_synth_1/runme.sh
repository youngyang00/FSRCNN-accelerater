...
HD_PWD='D:/FSRCNN_imple2/ip_repo/AXIS_Shrinking_Layer_v19.1_0910/AXIS_Shrinking_Layer_v19.1_0910.runs/shrink_dsp_macro_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shrink_dsp_macro_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shrink_dsp_macro_1.tcl
