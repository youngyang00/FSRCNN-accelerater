...
-- Date        : Wed Jul  2 12:08:01 2025
-- Host        : DESKTOP-DD0PJLS running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub -rename_top BicubicDDRTest_axi_smc_1 -prefix
--               BicubicDDRTest_axi_smc_1_ BicubicDDRTest_axi_smc_1_stub.vhdl
-- Design      : BicubicDDRTest_axi_smc_1
...
entity BicubicDDRTest_axi_smc_1 is
  Port ( 
    aclk : in STD_LOGIC;
...
end BicubicDDRTest_axi_smc_1;

architecture stub of BicubicDDRTest_axi_smc_1 is
...
attribute X_CORE_INFO of stub : architecture is "bd_442f,Vivado 2022.2";
begin
end;
