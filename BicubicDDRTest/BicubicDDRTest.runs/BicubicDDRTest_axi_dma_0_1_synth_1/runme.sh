...
HD_PWD='D:/Capstone/BicubicDDRTest/BicubicDDRTest.runs/BicubicDDRTest_axi_dma_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BicubicDDRTest_axi_dma_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BicubicDDRTest_axi_dma_0_1.tcl
