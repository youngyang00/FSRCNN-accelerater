...
HD_PWD='D:/Capstone/BicubicDDRTest/BicubicDDRTest.runs/BicubicDDRTest_rst_ps8_0_99M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BicubicDDRTest_rst_ps8_0_99M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BicubicDDRTest_rst_ps8_0_99M_0.tcl
