...
HD_PWD='D:/Capstone/BicubicDDRTest/BicubicDDRTest.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BicubicDDRTest_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BicubicDDRTest_wrapper.tcl -notrace
