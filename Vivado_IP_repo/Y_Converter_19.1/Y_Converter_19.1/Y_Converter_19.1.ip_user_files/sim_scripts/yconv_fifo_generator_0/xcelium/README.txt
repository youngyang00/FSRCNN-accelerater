...
#
# Generated by export_simulation on Sat Sep 06 07:09:52 +0900 2025
#
################################################################################
...
'-reset_run' switch to the './yconv_fifo_generator_0.sh' script.

./yconv_fifo_generator_0.sh -reset_run
...
./yconv_fifo_generator_0.sh -noclean_files

For more information on the script, please type './yconv_fifo_generator_0.sh -help'.
