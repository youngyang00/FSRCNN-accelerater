...
#
# Generated by export_simulation on Fri Sep 05 12:06:23 +0900 2025
#
################################################################################
...
'-reset_run' switch to the './expand_dsp48_macro_1.sh' script.

./expand_dsp48_macro_1.sh -reset_run
...
./expand_dsp48_macro_1.sh -noclean_files

For more information on the script, please type './expand_dsp48_macro_1.sh -help'.
