...
#
# Generated by export_simulation on Fri Sep 05 16:27:33 +0900 2025
#
################################################################################
...
'-reset_run' switch to the './deconv_fifo_generator_1.sh' script.

./deconv_fifo_generator_1.sh -reset_run
...
./deconv_fifo_generator_1.sh -noclean_files

For more information on the script, please type './deconv_fifo_generator_1.sh -help'.
