...
#
# Generated by export_simulation on Wed Jul 23 23:50:04 +0900 2025
#
################################################################################
...
'-reset_run' switch to the './dsp_Requant.sh' script.

./dsp_Requant.sh -reset_run
...
./dsp_Requant.sh -noclean_files

For more information on the script, please type './dsp_Requant.sh -help'.
