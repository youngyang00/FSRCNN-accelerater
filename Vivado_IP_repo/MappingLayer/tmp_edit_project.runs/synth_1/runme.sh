...
HD_PWD='d:/capstone/ip_repo/mappinglayer/tmp_edit_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AxiMappingLayer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AxiMappingLayer.tcl
