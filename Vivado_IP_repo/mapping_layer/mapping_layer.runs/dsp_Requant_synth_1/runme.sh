...
HD_PWD='D:/mapping_layer/mapping_layer.runs/dsp_Requant_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dsp_Requant.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dsp_Requant.tcl
