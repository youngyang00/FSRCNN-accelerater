...
HD_PWD='D:/mapping_layer/mapping_layer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_6x24_ff_async.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_6x24_ff_async.tcl
