...
#
# Generated by export_simulation on Fri Sep 05 10:53:08 +0900 2025
#
################################################################################
...
'-reset_run' switch to the './feature_dsp_macro_0.sh' script.

./feature_dsp_macro_0.sh -reset_run
...
./feature_dsp_macro_0.sh -noclean_files

For more information on the script, please type './feature_dsp_macro_0.sh -help'.
