...
#
# Generated by export_simulation on Thu Sep 11 22:20:53 +0900 2025
#
################################################################################
...
'-reset_run' switch to the './shrink_dsp_macro_1.sh' script.

./shrink_dsp_macro_1.sh -reset_run
...
./shrink_dsp_macro_1.sh -noclean_files

For more information on the script, please type './shrink_dsp_macro_1.sh -help'.
