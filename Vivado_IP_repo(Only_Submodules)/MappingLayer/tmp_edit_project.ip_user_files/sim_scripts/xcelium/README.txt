...
#
# Generated by export_simulation on Wed Jul 23 23:40:14 +0900 2025
#
################################################################################
...
'-reset_run' switch to the './tb_mappingLayer.sh' script.

./tb_mappingLayer.sh -reset_run
...
./tb_mappingLayer.sh -noclean_files

For more information on the script, please type './tb_mappingLayer.sh -help'.
