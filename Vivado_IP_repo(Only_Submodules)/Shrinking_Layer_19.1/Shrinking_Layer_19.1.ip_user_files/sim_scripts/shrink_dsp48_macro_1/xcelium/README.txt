...
#
# Generated by export_simulation on Fri Sep 05 11:40:27 +0900 2025
#
################################################################################
...
'-reset_run' switch to the './shrink_dsp48_macro_1.sh' script.

./shrink_dsp48_macro_1.sh -reset_run
...
./shrink_dsp48_macro_1.sh -noclean_files

For more information on the script, please type './shrink_dsp48_macro_1.sh -help'.
