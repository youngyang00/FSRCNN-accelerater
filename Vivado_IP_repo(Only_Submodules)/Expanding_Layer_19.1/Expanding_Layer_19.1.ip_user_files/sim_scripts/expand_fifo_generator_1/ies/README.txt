...
#
# Generated by export_simulation on Fri Sep 05 12:03:43 +0900 2025
#
################################################################################
...
'-reset_run' switch to the './expand_fifo_generator_1.sh' script.

./expand_fifo_generator_1.sh -reset_run
...
./expand_fifo_generator_1.sh -noclean_files

For more information on the script, please type './expand_fifo_generator_1.sh -help'.
