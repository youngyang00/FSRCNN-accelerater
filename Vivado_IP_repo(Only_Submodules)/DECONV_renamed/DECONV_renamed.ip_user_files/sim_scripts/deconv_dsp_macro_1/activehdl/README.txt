...
#
# Generated by export_simulation on Fri Sep 05 16:26:01 +0900 2025
#
################################################################################
...
'-reset_run' switch to the './deconv_dsp_macro_1.sh' script.

./deconv_dsp_macro_1.sh -reset_run
...
./deconv_dsp_macro_1.sh -noclean_files

For more information on the script, please type './deconv_dsp_macro_1.sh -help'.
