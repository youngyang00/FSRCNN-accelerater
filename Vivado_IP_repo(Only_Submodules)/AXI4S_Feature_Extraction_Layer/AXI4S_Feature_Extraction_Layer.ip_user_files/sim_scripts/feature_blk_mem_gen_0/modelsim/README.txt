...
#
# Generated by export_simulation on Fri Sep 05 23:50:50 +0900 2025
#
################################################################################
...
'-reset_run' switch to the './feature_blk_mem_gen_0.sh' script.

./feature_blk_mem_gen_0.sh -reset_run
...
./feature_blk_mem_gen_0.sh -noclean_files

For more information on the script, please type './feature_blk_mem_gen_0.sh -help'.
