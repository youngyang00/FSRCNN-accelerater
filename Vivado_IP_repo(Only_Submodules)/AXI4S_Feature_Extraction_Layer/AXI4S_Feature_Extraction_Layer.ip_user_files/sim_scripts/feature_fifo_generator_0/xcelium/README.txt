...
#
# Generated by export_simulation on Tue Sep 16 14:19:24 +0900 2025
#
################################################################################
...
'-reset_run' switch to the './feature_fifo_generator_0.sh' script.

./feature_fifo_generator_0.sh -reset_run
...
./feature_fifo_generator_0.sh -noclean_files

For more information on the script, please type './feature_fifo_generator_0.sh -help'.
