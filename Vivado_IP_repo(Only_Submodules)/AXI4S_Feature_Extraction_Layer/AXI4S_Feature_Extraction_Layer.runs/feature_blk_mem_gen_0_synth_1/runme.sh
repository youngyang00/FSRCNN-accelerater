...
HD_PWD='D:/FSRCNN/ip_Repo/AXI4S_Feature_Extraction_Layer/AXI4S_Feature_Extraction_Layer.runs/feature_blk_mem_gen_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log feature_blk_mem_gen_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source feature_blk_mem_gen_0.tcl
