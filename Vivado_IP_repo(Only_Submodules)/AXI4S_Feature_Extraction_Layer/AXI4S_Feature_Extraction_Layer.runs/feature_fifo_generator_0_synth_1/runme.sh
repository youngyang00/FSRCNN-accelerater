...
HD_PWD='C:/emergency/FSRCNN_imple2.vol1/ip_repo/AXI4S_Feature_Extraction_Layer/AXI4S_Feature_Extraction_Layer.runs/feature_fifo_generator_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log feature_fifo_generator_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source feature_fifo_generator_0.tcl
