...
HD_PWD='C:/submit/AXI4S_Feature_Extraction_Layer/AXI4S_Feature_Extraction_Layer.runs/feature_dsp_Requant_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log feature_dsp_Requant.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source feature_dsp_Requant.tcl
